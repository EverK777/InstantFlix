...
class PopularRemoteMediatorTest {
    ...
    private lateinit var popularRemoteMediator: PopularRemoteMediator

    @Before
    fun setUp() {
        popularRemoteMediator = PopularRemoteMediator(
    ...
    fun `load remote data and save to database`(): Unit = runBlocking {
        ...
        val result = popularRemoteMediator.load(LoadType.REFRESH, state = pagingState)
    ...
    fun `load remote data and save to database and not clearData`(): Unit = runBlocking {
        ...
        val result = popularRemoteMediator.load(LoadType.APPEND, state = pagingState)
